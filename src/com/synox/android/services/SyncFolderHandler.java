...
import com.synox.android.files.services.IndexedForest;
 ...
 * {@link com.synox.android.services.OperationsService#onCreate()}.
 */
class SyncFolderHandler extends Handler {
    ...
    public boolean isSynchronizing(Account account, String remotePath) {
        return !(account == null || remotePath == null) && (mPendingOperations.contains(account, remotePath));
    }
