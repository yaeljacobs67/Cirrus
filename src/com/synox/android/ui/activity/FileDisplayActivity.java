...
import com.synox.android.lib.common.network.CertificateCombinedException;
...
import com.synox.android.operations.CopyFileOperation;
import com.synox.android.operations.CreateFolderOperation;
import com.synox.android.operations.MoveFileOperation;
import com.synox.android.operations.RefreshFolderOperation;
import com.synox.android.operations.RemoveFileOperation;
import com.synox.android.operations.RenameFileOperation;
import com.synox.android.operations.SynchronizeFileOperation;
import com.synox.android.services.observer.FileObserverService;
import com.synox.android.syncadapter.FileSyncAdapter;
import com.synox.android.ui.dialog.ConfirmationDialogFragment;
import com.synox.android.ui.dialog.SslUntrustedCertDialog;
import com.synox.android.ui.dialog.SslUntrustedCertDialog.OnSslUntrustedCertListener;
import com.synox.android.ui.fragment.FileDetailFragment;
import com.synox.android.ui.fragment.FileFragment;
import com.synox.android.ui.fragment.OCFileListFragment;
import com.synox.android.ui.preview.PreviewImageActivity;
...
import com.synox.android.ui.preview.PreviewVideoActivity;
import com.synox.android.utils.DisplayUtils;
import com.synox.android.utils.ErrorMessageAdapter;
import com.synox.android.utils.PermissionUtil;
import com.synox.android.utils.UriUtils;
...
public class FileDisplayActivity extends FileActivity
    ...
    protected void onAccountSet(boolean stateWasRecovered) {
        ...
        if (getAccount() != null) {
            ...
            if (mAccountWasSet) {
                NavigationView navigationDrawerLayout = (NavigationView) findViewById(R.id.left_drawer);
    ...
    private void initFragmentsWithFile() {
        if (getAccount() != null && getFile() != null) {
            ...
            if (listOfFiles != null) {
                listOfFiles.listDirectory(getCurrentDir(), false, "initFragmentsWithFile");
    ...
    protected void refreshListOfFilesFragment() {
        ...
        if (fileListFragment != null) {
            fileListFragment.refreshDirectory("refreshListOfFilesFragment");
        }
    }
    ...
    private void requestMultipleUpload(Intent data, int resultCode) {
        ...
        if (filePaths != null) {
            ...
            if (getCurrentDir() != null && getCurrentDir().getRemotePath() != null) {
                remotePathBase = getCurrentDir().getRemotePath();
            }
    ...
    private void requestMoveOperation(Intent data, int resultCode) {
        ...
        Log.d(TAG, "requestMoveOperation result code : " + resultCode);
    }
    ...
    private void requestCopyOperation(Intent data, int resultCode) {
        ...
        Log.d(TAG, "requestCopyOperation result code : " + resultCode);
    }
                    ...
                    if (FileSyncAdapter.EVENT_FULL_SYNC_START.equals(event)) {
                        ...
                        if (currentDir == null) {
                            ...
                            if (synchFolderRemotePath != null &&
                                ...
                                if (fileListFragment != null && RefreshFolderOperation.EVENT_SINGLE_FOLDER_SHARES_SYNCED.equals(event)) {
                                    fileListFragment.refreshDirectory(event);
                                    Log_OC.d(TAG, "Received broadcast - refresh directory for " + event);
                                }
                            }
                            setFile(currentFile);
                        }
    ...
    public void browseToRoot() {
        ...
        if (listOfFiles != null) {  // should never be null, indeed
            ...
            listOfFiles.listDirectory(root, false, "browseToRoot");
            setFile(listOfFiles.getCurrentFile());
