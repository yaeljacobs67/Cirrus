...
import com.synox.android.authentication.AccountAuthenticator;
...
import com.synox.android.lib.common.accounts.AccountUtils;
...
import com.synox.android.utils.CopyTmpFileAsyncTask;
...
public class Uploader extends FileActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mRemoteCacheData = new ArrayList<>();
        } else {
                        ...
                        if (RefreshFolderOperation.EVENT_SINGLE_FOLDER_CONTENTS_SYNCED.
                                ...
                                (synchResult.getCode() == RemoteOperationResult.ResultCode.UNAUTHORIZED ||
                                        ...
                                        (synchResult.isException() && synchResult.getException()
                                                instanceof AccountAuthenticator.AuthenticatorException))) {
