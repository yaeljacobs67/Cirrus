...
public class ConfirmationDialogFragment extends DialogFragment {
    ...
    private View getContentView() {
        ...
        return inflater.inflate(R.layout.select_dialog_item_material, null);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(getActivity(), R.style.synox_Dialog)
