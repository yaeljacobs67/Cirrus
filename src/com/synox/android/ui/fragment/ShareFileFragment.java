...
import com.synox.android.ui.adapter.ShareUserListAdapter;
import com.synox.android.ui.dialog.ExpirationDatePickerDialogFragment;
...
//    private static final String FTAG_CHOOSER_DIALOG = "CHOOSER_DIALOG";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mFile.isImage()) {
            ...
            ThumbnailUtils.processThumbnail(mAccount,
                    mFile,
                    icon,
                    mFile.isFolder() ? MimetypeIconUtil.getFolderTypeIconId(mFile) :
     ...
     *
     * Depends on the parent Activity provides a {@link com.synox.android.datamodel.FileDataStorageManager}
