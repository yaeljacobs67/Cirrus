...
public class PreviewTextFragment extends FileFragment {
    ...
    public void onResume() {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(getFile().getFileName());
        ((AppCompatActivity) getActivity()).getSupportActionBar().setSubtitle(null);
        ((FileDisplayActivity) getActivity()).getDrawerToogle().setDrawerIndicatorEnabled(false);
