...
public class DbHandler {
    ...
    public DbHandler(Context context) {
        ...
        OpenerHelper mHelper = new OpenerHelper(context);
    ...
    public int updateFileState(String filepath, String message) {
        ContentValues cv = new ContentValues();
        cv.put("attempt", DbHandler.UPLOAD_STATUS_UPLOAD_FAILED);
        cv.put("message", message);
