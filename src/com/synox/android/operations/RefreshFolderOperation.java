...
import com.synox.android.lib.resources.shares.GetRemoteSharesForFileOperation;
import com.synox.android.lib.resources.files.ReadRemoteFileOperation;
import com.synox.android.lib.resources.files.ReadRemoteFolderOperation;
...
public class RefreshFolderOperation extends RemoteOperation {
    ...
    private void synchronizeData(ArrayList<Object> folderAndFiles, OwnCloudClient client) {
        ...
        OCFile remoteFile, localFile, updatedFile;
        RemoteFile r;
    ...
    private void sendLocalBroadcast(
        ...
        Log_OC.d(TAG, "Send broadcast completed" + event);
